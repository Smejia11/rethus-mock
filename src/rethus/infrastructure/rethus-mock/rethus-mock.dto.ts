...
export enum IdentificationType {
  ...
  FDI = 8, // FIDEICOMISO
  RC = 9, // REGISTRO CIVIL
  SI = 10, // SIN IDENTIFICACION
  DM = 11, // DOCUMENTO DE MIGRACION
  ADT = 12, // ASOCIADO AL DTO. DEL TITULAR
  CD = 13, // CERTIFICADO DE DEFUNCION
  NV = 14, // NACIDO VIVO
  TV = 15, // TARJETA DE VIAJERO
  RUT = 16, // REGISTRO UNICO TRIBUTARIO
  NME = 17, // NIT MIGRACION ESCOLARES
  NUI = 18, // NUMERO UNICO DE IDENTIFICACION
  JUD = 19, // DOCUMENTO JUDICIALES
  DC = 21, // DOCUMENTO JUDICIAL Y CONTRALOR
  PEP = 22, // PERMISO ESPECIAL PERMANENCIA
  PPT = 23, // PERMISO PROTECCION TEMPORAL
  NAD = 99, // ALERTA PERSONA NOADJUDICATARIO
}
